...
export default function rudie() {
    ...
    return (
        <div className="flex flex-col gap-6 items-center mt-24 lg:mt-12">
            <Image src={rude} alt="rudie" className="size-2/3 lg:size-1/6" unoptimized/>
            <Image src={bad} alt="bad bad" className="size-1/3 mt-24 lg:size-1/12 lg:mt-12" unoptimized/>
            <button className="bg-gray-500 rounded-lg w-36 flex mt-4" onClick={() => router.push("/")}>
                ...
                <Image src={angry} alt="Cute button" className="size-20" unoptimized/>
            </button>
